...
// WithName adds the name to the upload params
func (o *UploadParams) WithName(name string) *UploadParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the upload params
func (o *UploadParams) SetName(name string) {
	o.Name = name
}
