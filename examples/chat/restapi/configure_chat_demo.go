...
import (
	...
	"github.com/elakito/swagsock/examples/chat/models"
	"github.com/elakito/swagsock/examples/chat/restapi/operations"
...
func configureAPI(api *operations.ChatDemoAPI) http.Handler {
	...
	api.ChatHandler = operations.ChatHandlerFunc(func(params operations.ChatParams) middleware.Responder {
		...
		payload := &models.Message{Name: params.Name, Text: params.Body.Text, Type: "message"}
