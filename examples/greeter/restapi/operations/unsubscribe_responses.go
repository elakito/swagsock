...
/*UnsubscribeOK Returns the subscription summary
...
func (o *UnsubscribeOK) WithPayload(payload *models.GreetingSummary) *UnsubscribeOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the unsubscribe o k response
func (o *UnsubscribeOK) SetPayload(payload *models.GreetingSummary) {
	o.Payload = payload
}
